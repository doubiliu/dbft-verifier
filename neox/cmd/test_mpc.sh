...
go run mpccmd.go phase2 seal --srs ./meta/phase1/groth16.crs --input ./meta/phase2/rlp_contribute_1.phase2 --ccs ./meta/v1/rlp_encode_hash_extra_v1_test.ccs --pk ./meta/v1/rlp_encode_hash_extra_v1_test.pk --vk ./meta/v1/rlp_encode_hash_extra_v1_test.vk
...
go run mpccmd.go phase2 seal --srs ./meta/phase1/groth16.crs --input ./meta/phase2/g2_contribute_1.phase2 --ccs ./meta/v1/to_g2_hash.ccs --pk ./meta/v1/to_g2_hash.pk --vk ./meta/v1/to_g2_hash.vk
...
go run mpccmd.go phase2 seal --srs ./meta/phase2/groth16.crs --input ./meta/phase2/outer_contribute_1.phase2 --ccs ./meta/v1/verify_header_extra_v1.ccs --pk ./meta/v1/verify_header_extra_v1.pk --vk ./meta/v1/verify_header_extra_v1.vk --contract ./meta/v1/verify_header_extra_v1.sol
